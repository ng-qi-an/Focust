        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 20){
                    ...
                    NavigationLink(destination: SignupPassword(authenticated: $authenticated, password: $password, username: $username)) {
                        HStack {
                            Text("Sign Up")
                            Spacer()
                    ...
                    NavigationLink(destination: LoginView(authenticated: $authenticated, username: $username, password: $password)) {
                        HStack {
                            Text("Log In")
                            Spacer()
